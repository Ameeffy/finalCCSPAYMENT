...
const sendUserStatusUpdateEmailDeleteAdviser = async (email, firstname, middlename, lastname, orgName, status, adminFullName) => {
    try {
        let message = '';
        if (status === 'Activated') {
            message = `
...
module.exports = { sendSemesterStatusEmail, sendGcashOrderStatusEmail, sendGcashOrderReportEmail, sendOrganizationStatusEmail, sendOrganizationUserRegistrationEmail, 
    ...
    sendAdviserStatusUpdateEmailDelete,sendOrganizationStatusEmailDelete, sendUserStatusUpdateEmailDeleteAdviser };
